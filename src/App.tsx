...
function App() {
  ...
  useEffect(() => {
    if (gameStarted && gameState.currentTurn % 3 === 0 && gameState.currentTurn > 0) {
        ...
        <div className="welcome-content">
          ...
          <div className="welcome-description">
            <p>
              ...
              thực hiện các nước đi về kinh tế-tài chính, và theo dõi ảnh hưởng đến quyền lực và lợi ích quốc gia.
            </p>
          </div>
          ...
          <div className="game-info">
            ...
            <div className="info-section">
              <h3>🏦 Vai trò</h3>
              <ul>
                <li><strong>Ngân hàng/Quỹ:</strong> Đầu tư, mua cổ phần, phát triển fintech</li>
                <li><strong>Doanh nghiệp:</strong> Hợp tác vốn, mở rộng, chống thâu tóm</li>
                <li><strong>Chính phủ:</strong> Ban hành luật, kiểm soát vốn, bảo vệ ngành</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="right-panel">
          ...
          <div className="recent-actions">
            ...
            <div className="actions-scroll">
              {gameState.actions.slice(-10).reverse().map(action => (
          ...
          <div className="game-over-panel">
            ...
            <div className="final-metrics">
              ...
              <div className="metric">
                Kiểm soát nội địa: <strong>{gameState.nationalMetrics.domesticControl.toFixed(1)}%</strong>
              </div>
              <div className="metric">
                Chủ quyền kinh tế: <strong>{gameState.nationalMetrics.economicSovereignty.toFixed(1)}%</strong>
              </div>
              <div className="metric">
                Phụ thuộc ngoại: <strong>{gameState.nationalMetrics.foreignDependency.toFixed(1)}%</strong>
              </div>
            </div>
